      ...
      <div className="fade-up modal-sheet scrollbar-thin" style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 22 }}>
          ...
          <button onClick={onClose} style={{
            background: 'rgba(240,235,224,0.05)', border: '1px solid rgba(240,235,224,0.08)',
                ...
                {resultOptions.map(({ value, label, color }) => {
                  ...
                  return (
                    <button key={value} type="button" onClick={() => set('result', value)} style={{
                      ...
                      border: `1px solid ${active ? color + '60' : 'rgba(240,235,224,0.08)'}`,
                      background: active ? color + '18' : 'rgba(240,235,224,0.03)',
                  ...
                  {pickerOptions.map(({ value, label }) => {
                    ...
                    return (
                      <button key={value} type="button" onClick={() => set('picker', value)} style={{
                        ...
                        border: `1px solid ${active ? 'rgba(245,166,35,0.5)' : 'rgba(240,235,224,0.07)'}`,
                        background: active ? 'rgba(240,235,224,0.07)' : 'rgba(240,235,224,0.03)',
